...
void Shader::transmitUniformData(gsl::Matrix4x4 *modelMatrix, MaterialComponent *material)
{
...
void Shader::setCurrentCamera(CameraComponent *currentCamera)
{
    mCurrentCamera = currentCamera;
}

CameraComponent *Shader::getCurrentCamera() const
{
